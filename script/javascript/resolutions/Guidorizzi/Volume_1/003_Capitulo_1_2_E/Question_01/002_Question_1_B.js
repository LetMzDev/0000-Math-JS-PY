function initThreeJS ( containerId )
{
	...
	class MathematicalSolution
	{
		...
		createSolutionLine()
		{
			...
			//Solution: x < -2.  Represent this with a red line from -6 to -2, showing x is less than -2
			for ( let x = -6; x <= -2; x += 0.05 )
			{
		...
		createCriticalPoint()
		{
			...
			this.point.position.set ( -2, 0, 0 );  //critical point is now at -2
